...
TWITTER = getattr(settings, 'META_TWITTER', None)
TWITTER_CARD = getattr(settings, 'META_TWITTER_CARD', None)
FACEBOOK = getattr(settings, 'META_FACEBOOK', None)
FACEBOOK_APP = getattr(settings, 'META_FACEBOOK_APP', None)
LINKEDIN = getattr(settings, 'META_LINKEDIN', None)
GOOGLEPLUS = getattr(settings, 'META_GOOGLEPLUS', None)

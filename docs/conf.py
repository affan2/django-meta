...
latex_documents = [
  ('index', 'djangoCMSHelper.tex', 'Django App Helper Documentation',
...
man_pages = [
    ('index', 'djangometa', 'Django Meta Documentation',
     ['Iacopo Spalletti'], 1)
]
...
texinfo_documents = [
  ('index', 'djangometa', 'Django Meta Documentation',
   'Iacopo Spalletti', 'djangometa', 'One line description of project.',
   'Miscellaneous'),
]
